...
# load dataset
orders_df = pd.read_csv('dashboard/orders_df.csv', parse_dates=['order_purchase_timestamp'])
seller_df = pd.read_csv('dashboard/seller_df.csv')
rfm_df = pd.read_csv('dashboard/rfm_df.csv')
sellers_geolocation_df = pd.read_csv('dashboard/sellers_geolocation_df.csv')
